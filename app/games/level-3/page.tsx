...
export const metadata: Metadata = {
  title: "Mid Elementary Math Games | Level 3 Games for Ages 8-10",
  description:
    "Free mid-elementary math games for ages 8–10. Master multiplication, division, fractions, and geometry through exciting interactive challenges.",
};

export default function Level3Page() {
  const level = getLevelInfo("level-3")!;
  const games = getGamesByLevel("level-3");

  return (
    <>
      <section className="page-hero" aria-labelledby="level3-heading">
        <div className="section-container">
          ...
          <h1 id="level3-heading" style={{ fontFamily: "Outfit, sans-serif", fontWeight: 900, fontSize: "clamp(2rem, 5vw, 3.5rem)", marginBottom: "0.75rem" }}>
