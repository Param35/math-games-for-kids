...
export const metadata: Metadata = {
  title: "Early Elementary Math Games | Level 2 Games for Ages 6-8",
  description:
    "Free early elementary math games for ages 6–8. Addition, subtraction, number patterns and more to build confidence and number fluency.",
};

export default function Level2Page() {
  const level = getLevelInfo("level-2")!;
  const games = getGamesByLevel("level-2");

  return (
    <>
      <section className="page-hero" aria-labelledby="level2-heading">
        <div className="section-container">
          ...
          <h1 id="level2-heading" style={{ fontFamily: "Outfit, sans-serif", fontWeight: 900, fontSize: "clamp(2rem, 5vw, 3.5rem)", marginBottom: "0.75rem" }}>
